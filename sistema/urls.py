...
urlpatterns = [
    ...
    path("rota-motoboy/<int:pk>/concluir/", rota_motoboy_views.rota_motoboy_concluir, name="rota_motoboy_concluir"),
    path("rota-motoboy/<int:pk>/excluir/", rota_motoboy_views.rota_motoboy_excluir, name="rota_motoboy_excluir"),
